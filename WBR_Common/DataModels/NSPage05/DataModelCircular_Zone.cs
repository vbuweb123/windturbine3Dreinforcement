    ...
    public class DataModelCircular_Zone : DataModel, IDataModelCircularZone
    {
        ...
        public void Set_OffsetFromEdge()
        {
            switch (Position)
            {
                case EZonePosition.Start:
                    int diameterNominalSize = Calculator.GetNominalSize((EDiameters)SelectedIndexDiameter, this.globalData);
                    var SelectedDiameterEdgeCirculars = this.globalData.GDMPage04.DataModelCircularGeneral.SelectedDiameterEdgeCirculars;
                    int diameterEdgeCircularNominalSize = Calculator.GetNominalSize((EDiameters)SelectedDiameterEdgeCirculars, this.globalData);

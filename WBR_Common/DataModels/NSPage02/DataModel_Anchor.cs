...
namespace WBR_Common.DataModels.NSPage02
{
    public class DataModel_Anchor : DataModel
    {
        ...
        [DynGet(DynKey = "DiameterAnchorInt")]
        ...
        [DynGet(DynKey = "Peshrinkhoseheigth")]
        ...
        [DynGet(DynKey = "FilletBottomZone")]
        ...
        //NO SAVE CODE REQUIRED
        [DynGet(DynKey = "DepthAnchorBottom")]
        ...
        [DynGet(DynKey = "InsertionDepthTopFlange")]
        ...
        [DynGet(DynKey = "ThicknessTopFlange")]
        ...
        [DynGet(DynKey = "WidthConcreteBed")]
        ...
        [DynGet(DynKey = "DepthConcreteBed")]
        ...
        //NO SAVE CODE REQUIRED
        [DynGet(DynKey = "DispanceBoltPairs")]
        ...
        [DynGet(DynKey = "ThicknessBottFlange")]
        ...
        //NO SAVE CODE REQUIRED
        [DynGet(DynKey = "OffsetBottFlange")]
        ...
        {
            RadiusCenterLineTower = (int)(Math.Round((double)DiameterAnchor / 2, 0) - Math.Round((double)DispanceBoltPairs / 2, 0));
        }
        private void Set_DistanceBoltPairs()
        {
            DispanceBoltPairs = (int)(Math.Round((double)(DiameterAnchor - DiameterAnchorInt) / 2, 0));
        }
